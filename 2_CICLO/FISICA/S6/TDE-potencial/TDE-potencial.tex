...
\begin{questions}
	...
	\[
		W = q \cdot \Delta V \implies \Delta V = \frac{W}{q} = \frac{6.25 \, \text{J}}{12.5 \, \text{C}} = 0.5 \, \text{V}
	\]
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Carga
			\node at (0,-0.5) [below] {$q = 12.5 \, \text{C}$};

			% Trabajo realizado
			\node at (0, 1.5) {$W = 6.25 \, \text{J}$};
	...
	Por lo tanto, el trabajo necesario para ensamblar las cargas en los vértices del hexágono es de \( 9.9\, \text{J} \) cuando \( a = 0.25 \, \text{m} \).
